...
!     
!------------------------------------------------------------------------
!> Driver Finalization routine called by WaveT or other programs 
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> a small routine to retrive the solvent contribution to free energies
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> a small routine to retrive the medium dipole for spectra            
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> a small routine to set the value of the charges from outside        
!------------------------------------------------------------------------
...
!
!------------------------------------------------------------------------
!> Build interaction matrix at time 0 
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Initialize charges for propagation
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Initialize Dipoles and Field for propagation 
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Called by init_dip_spho to initialize free_energy (spheroidal)         
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Called by init_dip_sphe to initialize free_energy (spherical)         
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> deallocate propagation variables                                      
!------------------------------------------------------------------------
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!------------------------------------------------------------------------
!> Driver routine for potential-charges propagation                
!------------------------------------------------------------------------
      subroutine prop_chr
       ! Propagate
...
!     
!------------------------------------------------------------------------
!> Driver routine for dipole-field propagation                
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Initialization for velocity-verlet propagation (vv)                 
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Drude-Lorentz propagation of charges with onsager-BEM equations    
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Debye propagation Fprop=chr-ief  
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Debye propagation Fprop=chr-ied  
!------------------------------------------------------------------------
...
!
!------------------------------------------------------------------------
!> Debye propagation of the spheroid reaction and local fields 
!------------------------------------------------------------------------
...
!
!------------------------------------------------------------------------
!> Debye propagation of the sphere reaction and local fields 
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Drude-Lorentz propagation of the spheroid reaction and local fields 
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Drude-Lorentz propagation of the sphere reaction and local fields
!! (to be merged with spheroid version) 
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> a small subroutine to fetch the current value of the onsager field from elsewhere
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> routine to update non equilibrium free-energy 
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Test for Solvent/Nanoparticle reaction/local fields 
!------------------------------------------------------------------------
      subroutine do_ref(c)      
      complex(cmp), intent(IN) :: c(n_ci)
...
!     
!------------------------------------------------------------------------
!> Output medium reaction/local field/dipoles
!------------------------------------------------------------------------
...
!     
!------------------------------------------------------------------------
!> Read charges from gaussian "charges0.inp" output         
!------------------------------------------------------------------------
