...
!     TO BE COMPLETED, SEE PROPAGATE.F90      
      ...
      private
      public read_input,n_ci,n_step,dt,cfric,Ffld,t_mid,sigma,omega,fmax, & 
             mdm,mol_cc,tau,start,c_i,e_ci,mut,ui,pi,zero,one,two,twp,&
             one_i,onec,twoc,pt5,rad,n_out,iseed,n_f,dir_ft,diss
!
      contains
!
      subroutine read_input
       ...
       read(5,*) diss,cfric
       write (6,*) "Set env dissip, Fric Coef, randseed generation", diss,cfric
       read(5,*) Ffld             
